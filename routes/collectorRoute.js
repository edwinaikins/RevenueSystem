...
router.get("/getCollectorBusinessSummary/:collectorId/:year",ensureAuthenticated, collectorController.getCollectorBusinessSummary);
router.get("/getCollectorPropertySummary/:collectorId/:year",ensureAuthenticated, collectorController.getCollectorPropertySummary);
router.get("/getCollectorSignageSummary/:collectorId/:year",ensureAuthenticated, collectorController.getCollectorSignageSummary);
